...
3. Cross-checks the output script against read-only calls to [`ST000000000000000000002AMW42H.pox-5`](https://explorer.hiro.so/txid/ST000000000000000000002AMW42H.pox-5?chain=testnet) (private-1) or [`SP000000000000000000002Q6VF78.pox-5`](https://explorer.hiro.so/txid/SP000000000000000000002Q6VF78.pox-5?chain=mainnet) (mainnet).
